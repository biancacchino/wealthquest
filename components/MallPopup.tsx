...
export const MallPopup: React.FC<MallPopupProps> = ({
  title,
  items,
  userBalance,
  bankBalance = 0,
    ...
    <div className="fixed inset-0 z-20 bg-black/80 flex items-center justify-center p-4">
      <div
        ...
        style={{
          ...
          border: "6px solid #c85a8a",
          borderRadius: "8px",
          boxShadow:
            "inset 2px 2px 0 #f8a0c0, inset -2px -2px 0 #a04070, 8px 8px 0 rgba(0,0,0,0.5)",
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundColor: "#c85a8a",
            borderBottom: "4px solid #a04070",
        ...
        >
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col">
                    ...
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: isSelected
                          ...
                          : "inset 1px 1px 0 #fff, inset -1px -1px 0 #a888a8",
                        padding: "8px 12px",
                      }}
                    >
              ...
              >
                <div className="text-xs font-bold" style={{ color: "#c85a8a" }}>
                ...
                {selectedItem && (
                  <div className="text-[10px] mt-2" style={{ color: "#6b7280" }}>
                    ...
                    {selectedItem.category === 'want' && selectedItem.price > 20 && (
                      <div className="text-orange-600 mt-1 font-bold">
                        💭 Big purchase! Is this something you really need?
                      </div>
                    )}
                  </div>
                )}
